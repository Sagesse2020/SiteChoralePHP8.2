...
<head>
    ...
    <title>{{ config('app.name')}}-Formulaire galerie</title>
     <style>
        h1{
     color: red;
     }
...
<nav class="navbar navbar-expand-lg_light">
    <div class="container">
      ...
      <li class="nav-item">
      <a class="nav-link @if(Request::route()->getName() == 'galeries.create') active @endif" aria-current="page" href="{{ route('galeries.create') }}">Enregistrement du contenu de la galerie</a>
      </li>
       <li class="nav-item">
