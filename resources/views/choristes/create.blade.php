...
<body>
    <div class="container mt-5">
       <h1>Enregistrement d'un nouveau choriste</h1>
        @if(session('success'))
        ...
        <form action="{{ route('choristes.store') }}" method="POST">
            @csrf

            <!-- Champs pour la table Client -->
            <div class="mb-5">
                <label for="nom" class="form-label">Nom complet du choriste</label> <br>
